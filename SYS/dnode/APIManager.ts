...
function _method_shell(sockPath, funcId, paramArray:any[]) {
    if (paramArray) {
...
//Returns Shadow
export function GetAPI(sockPath):API_Endpoint {
    ...
    for (var funcid in apiConfig) {
        ...
        cur[moduleEntry['funcName']] = ((funcid) => {
            return function () {
                _method_shell(sockPath, funcid, <any>arguments);
            }
        })(funcid);
    }
