 ...
 *  mapping: { moduleName: { moduleName, pid, mount, rpc, sockPath,  [funcid...] } }
...
export class MountTable {
    ...
    public static SetSocketPath(modulename, sockPath) {
        MountTable.mapping[modulename]['sockPath'] = sockPath;
    }
