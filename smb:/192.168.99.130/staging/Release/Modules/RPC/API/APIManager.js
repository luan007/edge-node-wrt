...
var _RPCEndpoint = require("../RPC/RPCEndpoint");
var _api_functions = [];
...
function GetAPI(api_skeleton, rpc) {
    if (api_skeleton["substr"]) {
        api_skeleton = JSON.parse(api_skeleton);
    }
    var _API_Endpoint = {};
    ...
    for (var i in api_skeleton.f) {
        ...
        cur[d[d.length - 1]] = (function (i) {
            return function () {
                _method_shell(_API_Endpoint.rpc_endpoint, api_skeleton.f[i], arguments);
            };
        })(i);
    }
