...
declare module "orm" {
    ...
    module orm {
        ...
        **/
        ...
        /*Patched by Mike Luan - Project Edge*/
        /*  - better types, less <casts>*/


        module Typed {


            export interface TypedIAggregated<T extends Instance> extends IAggregated {
                groupBy(...columns: string[]): TypedIAggregated<T>;
                limit(limit: number): TypedIAggregated<T>;
                limit(offset: number, limit: number): TypedIAggregated<T>;
                order(...order: string[]): TypedIAggregated<T>;
                select(columns: string[]): TypedIAggregated<T>;
                select(...columns: string[]): TypedIAggregated<T>;
                as(alias: string): TypedIAggregated<T>;
                call(fun: string, args: any[]): TypedIAggregated<T>;
                get(callback: (err: Error, instance: T) => void);
            }


            export interface TypedChainFind<T extends Instance> extends IChainFind {
                find(conditions: { [property: string]: any }): TypedChainFind<T>;
                only(...args: string[]): TypedChainFind<T>;
                limit(limit: number): TypedChainFind<T>;
                offset(offset: number): TypedChainFind<T>;
                run(callback: (err: Error, results: T[]) => void): void;
                count(callback: (err: Error, count: number) => void): void;
                remove(callback: (err: Error) => void): void;
                save(callback: (err: Error) => void): void;
                each(callback: (result: T) => void): void;
                each(): IChainFind;
            ...
            export interface TypedModel<T extends Instance> extends Model {
                (): T;
                (...ids: any[]): T;
                ...
                drop(callback?: (err: Error) => void): TypedModel<T>;
                sync(callback?: (err: Error) => void): TypedModel<T>;
                get(id: any, callback?: (err: Error, result: T) => void): TypedModel<T>;
                get(...args: any[]): TypedModel<T>;
                find(conditions: { [property: string]: any }, callback: (err: Error, results: T[]) => void): TypedModel<T>;
                find(conditions: { [property: string]: any }, options: {
                    limit?: number;
                    order?: any;
                }, callback: (err: Error, results: T[]) => void): Model;
                find(conditions: { [property: string]: any }, limit: number, order: string[], callback: (err: Error, results: T[]) => void): TypedModel<T>;
                find(conditions: { [property: string]: any }): TypedChainFind<T>;


                all(conditions: { [property: string]: any }, callback: (err: Error, results: T[]) => void): TypedModel<T>;
                all(conditions: { [property: string]: any }, options: {
                    limit?: number;
                    order?: any;
                }, callback: (err: Error, results: T[]) => void): TypedModel<T>;
                all(conditions: { [property: string]: any }, limit: number, order: string[], callback: (err: Error, results: T[]) => void): TypedModel<T>;


                one(conditions: { [property: string]: any }, callback: (err: Error, result: T) => void): TypedModel<T>;
                one(conditions: { [property: string]: any }, options: {
                    limit?: number;
                    order?: any;
                }, callback: (err: Error, result: T) => void): TypedModel<T>;
                one(conditions: { [property: string]: any }, limit: number, order: string[], callback: (err: Error, result: T) => void): TypedModel<T>;


                count(callback: (err: Error, count: number) => void): TypedModel<T>;
                count(conditions: { [property: string]: any }, callback: (err: Error, count: number) => void): TypedModel<T>;


                aggregate(conditions: { [property: string]: any }): TypedIAggregated<T>;
                aggregate(properties: string[]): TypedIAggregated<T>;
                aggregate(conditions: { [property: string]: any }, properties: string[]): TypedIAggregated<T>;


                exists(id: any, callback: (err: Error, exists: boolean) => void): TypedModel<T>;
                exists(...args: any[]): Model;


                create(data: { [property: string]: any; }, callback: (err: Error, instance: T) => void): TypedModel<T>;
                //create(...args: any[]): TypedModel<T>;
                create(...args: T[]): TypedModel<T>;
                create(...args: any[]): TypedModel<T>;
