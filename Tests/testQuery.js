var devices = {
    '4866102f06de4f38bc30592e001cf423': {
        assumptions: {},
        bus: {hwaddr: '88:63:df:a0:d7:03', name: 'WIFI'},
        owner: '',
        config: {},
    ...
    'd935869b80f542a9bf3f6a59d4f635f1': {
        assumptions: {},
        bus: {hwaddr: '20:76:93:23:a6:c8', name: 'WIFI'},
        owner: '',
        config: {},
    ...
    '741dc8f96dfa4bcc863278b908a4467d': {
        assumptions: {},
        bus: {hwaddr: '60:d9:c7:41:d4:71', name: 'WIFI'},
        owner: '',
        config: {},
    ...
    '1f69203d5f354272afc3471bcb7d5b34': {
        assumptions: {},
        bus: {hwaddr: '5c:51:4f:50:3a:84', name: 'WIFI'},
        owner: '',
        config: {},
...
var query = SpahQL.db(devices);
var res = query.select('/*[/bus/name =~ "WIFI"][/state == 1]').values();
console.log(res);